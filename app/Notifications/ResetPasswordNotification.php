...
class ResetPasswordNotification extends ResetPassword
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Sabor a Pueblo - Restablece tu contraseña'))
            ...
            ->line(Lang::get('Si no solicitaste un cambio de contraseña, no es necesario realizar ninguna otra acción.'))
